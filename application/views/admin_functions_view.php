      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div style="height: 0px;" class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="<?php echo base_url(); ?>index.php/admin/admin_panel">Home</a></li>
...
<li><a href="<?php echo base_url(); ?>index.php/admin/add_survey" style="position:relative; top:100px;">Add a survey</a></li>
